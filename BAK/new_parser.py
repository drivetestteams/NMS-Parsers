...
class SimpleSchedulerApp:
    ...
    def __init__(self, root):
        ...
        self.root.after(100, self.run_script_in_thread(Triskelion_Live_Parser_path))
        self.root.after(300, self.run_script_in_thread(FourSkelion_Historic_path))
        self.root.after(500, self.run_script_in_thread(FourSkelion_Live_path))
        self.root.after(700, self.run_script_in_thread(TriSkelion_Parser_path))
        self.root.after(900, self.run_script_in_thread("Restart_telemetry"))
